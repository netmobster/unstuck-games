...
(function () {
  ...
  css.textContent = [
    ...
    ".ug-go{flex:none;display:inline-flex;align-items:center;gap:7px;padding:9px 14px;background:#ffd23f;",
    ...
    ".ug-go svg{display:block;width:20px;height:10px;overflow:visible}",
